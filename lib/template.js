...
module.exports = {
  ...
  html: (title, body) => {
    ...
    <body>
      ...
      <div>
        <input id="btnScrTop" class="btn btn-info" type="button" value="top" style=" position: fixed; width:50px; height:50px; right: 20px; bottom: 30px;" >
      </div>
    </body>
...
<!-- login 로그인 -->
    ...
    var login =
      ...
      <form class="form-inline my-2 my-lg-0" action=""> <!-- /login_process -->
        <div>
          ...
          <span><input type="button" value="login" onclick="location.replace('/community/login_process)" class="btn btn-dark"></span>
  ...
  write: (sldodata) => {
    ...
    <form class="form my-2 my-lg-0" action="submit">
      <div class="my-3">
        <h4><input type="text" style="width: 540px;" placeholder="제목"></h4>
        <b>${sldodata[0].name}</b>
      </div>
      <div class="mt-3 text-center">
        <textarea style="width:100%; height: 480px;"></textarea>
      </div>
      <div>
        <span class="mr-2">
          <input type="button" value="저장" onclick="location.replace('/community/write_process')" class="btn btn-primary">
        </span>
        <span>
